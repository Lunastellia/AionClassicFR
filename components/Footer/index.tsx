    ...
    <footer className={cn(font.className, styles.footer)}>
      <section className={styles.container}>
        <p className={styles.logoText}>
          ...
          <span><a href="https://discord.gg/3KFcCyNZjU" className={styles.link}> Discord</a>ㅤ</span>
          <img src={"images/logoGithubd.svg"} className={styles.logo} alt="logoGithub" />
          <span><a href="https://github.com/Lunastellia/AionClassicFR" className={styles.link}>Github</a>ㅤPar Lunastellia. ㅤㅤ---ㅤㅤ</span>
        </p>
      </section>
      <section className={styles.container}>
        <p className={styles.logoText}>
